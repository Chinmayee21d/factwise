...
export default function DemoFocusRail() {
  return (
    <main className="overflow-x-hidden w-full bg-[#0a0a0c] flex flex-col items-center justify-center py-20">
      {/* Title */}
      <div className="mb-12 text-center">
        <h1 className="text-4xl font-bold text-[#f4f4f5] mb-2">Featured Stories</h1>
        <p className="text-[#6b6b7a]">Navigate the rail to explore selected works.</p>
      </div>
