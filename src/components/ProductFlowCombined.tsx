...
const NODES: NodeDef[] = [
  ...
  { id: 'custom-formula', label: 'Custom Formula Calculations', x: 68, y: 75 },
  { id: 'po-crea',    label: 'PO Creation',                 x: 92, y: 36 },
  { id: 'inv-crea',   label: 'Seller Invoice Creation',     x: 92, y: 50 },
  { id: 'gr',         label: 'Goods Receipt',               x: 92, y: 64 },
  { id: 'qc',         label: 'Quality Check',               x: 92, y: 78 },
  { id: 'pay',        label: 'Payments',                    x: 92, y: 92 },
];
  ...
  return (
    <div id="product-flow-combined" className="pfc-responsive-pad" style={{ position: 'relative', scrollMarginTop: '100px' }}>
      <div style={{ position: 'relative', overflow: 'hidden', borderRadius: '24px', backgroundImage: "url('/TexturedGradient.png')", backgroundSize: 'cover', backgroundPosition: 'center', padding: '80px 0' }}>
        <div style={{ position: 'absolute', right: '-100px', bottom: '-100px', width: '600px', height: '600px', borderRadius: '50%', background: 'radial-gradient(circle, rgba(54, 102, 255, 0.15) 0%, transparent 70%)', filter: 'blur(80px)', pointerEvents: 'none' }} />
        <div className="noise" style={{ position: 'absolute', inset: 0, opacity: 0.12, pointerEvents: 'none', mixBlendMode: 'overlay' }} />
