...
const problems: ProblemItem[] = [
  {
    ...
    subtitle: 'Invoices arrive in every format, from every channel — without structure.',
    description: 'PDFs, WhatsApp photos, paper hand-offs — invoices land without structure, get re-keyed manually, and by the time anyone matches them to a PO, errors are in and payments are late.',
  },
  {
    id: 'no-gr-visibility',
    number: '02',
    ...
    subtitle: 'No structured goods receipts means no idea what actually arrived.',
    description: "Without structured GRs, there's no track of what was delivered, short-shipped, damaged, or rejected — leaving your team blind to stock, pending items, and follow-ups.",
  },
  {
    id: 'qc-lost',
    number: '03',
    ...
    subtitle: 'Quality checks recorded on paper or chat never reach the system.',
    description: 'Inspections happen in notebooks or over WhatsApp — rejected quantities never tracked, accepted ones never verified, and the data reaches finance late, incomplete, or lost.',
  },
  {
    id: 'manual-matching',
    number: '04',
    ...
    subtitle: 'Without automated 4-way matching, payments go out on incomplete data.',
    description: "Without automated 4-way matching, overpayments, duplicates, and missed deductions for rejected goods all happen regularly — eating into margins you didn't need to lose.",
  },
  {
    id: 'no-visibility',
    number: '05',
