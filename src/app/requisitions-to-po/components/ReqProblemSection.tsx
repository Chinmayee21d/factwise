...
const problems: ProblemItem[] = [
  {
    ...
    subtitle: 'Purchase requisitions with no structure, no tracking, no control.',
    description: 'Requisitions come in from everywhere — emails, calls, messages. There\'s no standard format, no visibility into what\'s been raised, and no way to track where approvals stand. Things get missed, duplicated, or approved without the right oversight.',
  },
  {
    id: 'bulk-discount',
    number: '02',
    ...
    subtitle: 'Sourcing items one requisition at a time means paying more than you should.',
    description: 'When requisitions are handled independently, you lose the opportunity to combine quantities across requests and negotiate better prices. Every order placed in isolation is a bulk discount missed — and a cost that didn\'t need to be that high.',
  },
  {
    id: 'email-rfq',
    number: '03',
    ...
    subtitle: 'Vendor communication runs on emails nobody tracks.',
    description: 'RFQs sent over email, follow-ups that go unanswered, responses scattered across inboxes. By the time all vendor bids are in, days have passed, half the data is missing, and negotiations haven\'t even started.',
  },
  {
    id: 'landed-cost',
    number: '04',
    ...
    subtitle: 'Awarding on unit price alone is costing you more than you think.',
    description: 'Without true landed cost visibility across bids, teams award to the wrong vendor. Duties, freight, insurance, and packaging don\'t show up until after the PO is issued — and by then, the margin is already gone.',
  },
  {
    id: 'manual-po',
    number: '05',
    ...
    subtitle: 'Creating POs one by one is slow, error-prone, and completely unnecessary.',
    description: 'After shortlisting bids, most teams manually create individual POs for each vendor — copying line items, checking quantities, hoping nothing gets missed. One error and the wrong quantity ships. One delay and production stops.',
  },
]
