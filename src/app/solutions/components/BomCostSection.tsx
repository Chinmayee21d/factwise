        ...
        <div id="section-3-1" className="grid lg:grid-cols-12 gap-12 lg:gap-20 items-center mb-40 scroll-mt-24">
            ...
            >
                ...
                <p className="text-slate-500 text-[15px] leading-[1.65] font-normal" style={{ fontFamily: 'var(--font-inter)' }}>
                    Build complex multi-level BOMs with alternates in a single import. FactWise surfaces accurate line-item costs — <span className="font-semibold text-slate-700">distributor, past PO, quote, and contract prices</span> — before any RFQ goes out.
                </p>
                <p className="text-slate-500 text-[15px] leading-[1.65] font-normal" style={{ fontFamily: 'var(--font-inter)' }}>
