...
/* ──────────────────────────────────────────────────────────────────────
   SECTION 3.3 — See True Landed Cost. Award with Confidence.
...
const LC_VENDORS = [
    ...
    { id: 'B', name: 'Vendor B', loc: 'CN', fx: 'USD', tone: '#0d9488' },
    { id: 'C', name: 'Vendor C', loc: 'DE', fx: 'EUR', tone: '#7c3aed' },
    { id: 'D', name: 'Vendor D', loc: 'US', fx: 'USD', tone: '#f59e0b' },
];
...
const LC_LAYERS = [
    { k: 'q' as const, name: 'Quote',     tone: '#475569', bg: '#e2e8f0' },
    { k: 'd' as const, name: 'Duty',      tone: '#b45309', bg: '#fde68a' },
    { k: 'f' as const, name: 'Freight',   tone: '#6d28d9', bg: '#ddd5ff' },
    { k: 'i' as const, name: 'Insurance', tone: '#0e7490', bg: '#a5f3fc' },
];
...
const STEPS_MENU = [
    ...
    { p: 4, title: 'FW Recommended · Award' },
];
...
.lc-tbl { display: grid; grid-template-columns: 92px repeat(4, 1fr); gap: 4px; align-content: start; }
...
.lc-tot { background: #0b1322; color: white; border-radius: 7px; padding: 7px 8px;
  display: flex; flex-direction: column; gap: 2px; align-items: flex-end;
  transition: transform .55s cubic-bezier(0.4,0,0.2,1), background .35s; position: relative; }
...
.lc-card { background: white; border: 1px solid #e9eef5; border-radius: 12px;
  padding: 10px 11px; box-shadow: 0 8px 22px -12px rgba(15,23,42,0.08); }
        ...
        <div id="quote-section-3-3" className="grid lg:grid-cols-12 gap-12 lg:gap-20 items-center mb-40 scroll-mt-24">
            ...
            >
                ...
                <p className="text-slate-500 text-[15px] leading-[1.65] font-normal" style={{ fontFamily: 'var(--font-inter)' }}>
                    FactWise auto-applies your custom landed-cost formula across every bid — duty, freight, insurance — and normalizes every currency to yours. Every comparison reflects true cost, not unit price.
                </p>
                <p className="text-slate-500 text-[15px] leading-[1.65] font-normal" style={{ fontFamily: 'var(--font-inter)' }}>
                    FactWise Recommended Analytics scores every bid against your criteria, surfaces the true low cost, and explains why — every award decision backed by intelligence, not instinct.
                </p>
            ...
            >
                <div className="lc-root">
                    <div className="lc-chrome">
                        <div className="lc-url">app.factwise.io / award / RFQ-208</div>
                        ...
                        <div className="lc-rail">
                            <div className="lc-card">
                                ...
                                <div className={`lc-award ${awardGlow ? 'glow' : ''}`}>
                                    <LCI.Trophy s={12} /> Award · {LC_VENDORS.find((v) => v.id === winnerId)?.name} · {lcL(totals[winnerId])}
                                </div>
                            </div>
