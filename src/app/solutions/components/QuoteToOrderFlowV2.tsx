    ...
    return (
        <>
            ...
            <section style={{ background: 'white', padding: '80px 24px 60px', textAlign: 'center' }}>
                <div style={{ maxWidth: 1240, margin: '0 auto' }}>
                    ...
                    >
                        ...
                        The FactWise Quote-to-Order Engine
                    </div>
                    <h2
                        style={{
                    ...
                    >
                        Four core capabilities that <span style={{ color: '#3666ff' }}>change everything</span> about procurement.
                    </h2>
                    <p style={{ fontSize: 17, lineHeight: 1.65, color: '#64748b', maxWidth: 640, margin: '0 auto', fontFamily: 'var(--font-inter)' }}>
                        From multi-level BOM to AI-recommended award — intelligent at every step, automated at every turn.
                    </p>
                </div>
            </section>
            ...
            >
                ...
                {/* PANEL 1 — Source in Minutes · AI Negotiate (blue corner gradient) */}
                <div
                ...
                {/* PANEL 3 — Quote AI Insight (blue corner gradient) */}
                <div
                    className="qtof-panel qtof-panel-slide"
                    style={{
                        position: 'absolute', top: 0, left: 0, width: '100%', height: '100%',
