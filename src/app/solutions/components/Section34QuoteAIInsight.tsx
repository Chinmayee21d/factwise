...
const QA_SOURCES = [
    ...
    { id: 'S2', label: 'EVT-7740', name: 'Vendor B · drive', tone: '#0d9488', rgb: '13,148,136', items: ['Shaft Assy', 'Bearings'], sub: 142000 },
    { id: 'S3', label: 'EVT-7738', name: 'Vendor C · ctrl', tone: '#7c3aed', rgb: '124,58,237', items: ['Control Board', 'MCU + Caps'], sub: 196000 },
];
...
.qa-h .n { background: #0b1322; color: white; padding: 1px 5px; border-radius: 99px; font-size: 8px; }
...
.qa-tot-r.final { padding: 5px 8px; margin-top: 3px; background: #0b1322; color: white;
  border-radius: 7px; }
.qa-tot-r.final .l { color: #94a3b8; }
.qa-tot-r.final .v { color: white; font-size: 13px; }
...
.qa-ai-hd .t { font-size: 10.5px; font-weight: 800; }
...
.qa-prompt { display: flex; align-items: center; gap: 6px; padding: 6px 8px;
  ...
  border-radius: 7px; font-size: 9.5px; color: #cbd5e1; }
.qa-prompt .cur { display: inline-block; width: 1.5px; height: 10px; background: #00d196;
...
.qa-answer .body .head { font-size: 9.5px; font-weight: 600; color: white; margin-bottom: 4px; line-height: 1.3; }
...
.qa-bar .track { height: 5px; background: rgba(255,255,255,0.06); border-radius: 99px;
...
.qa-insight { display: flex; gap: 5px; align-items: flex-start;
  padding: 5px 7px; background: rgba(0,209,150,0.08);
  border: 1px solid rgba(0,209,150,0.18); border-radius: 7px;
  font-size: 9.5px; color: #d1fae5; line-height: 1.35;
...
.qa-send-wrap { display: flex; align-items: center; gap: 7px; padding-top: 5px;
  margin-top: auto; border-top: 1px dashed rgba(255,255,255,0.1); }
